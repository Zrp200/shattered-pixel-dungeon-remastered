	...
	public void explode(int cell) {
		...
		for (Char ch : affected){
			...
			if (power > 0){
				...
				int damage = round(Random.NormalIntRange(5 + Dungeon.scalingDepth(), 10 + 2*Dungeon.scalingDepth()) * (power/50f));
		...
		Dungeon.hero.sprite.getParent().addToFront(new Lightning(arcs, null));
